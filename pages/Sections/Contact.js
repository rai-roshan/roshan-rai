...
export default function Contact() {
    return (
        <div id="contact" className="relative flex flex-col min-h-screen items-center pt-5">
            ...
            <footer className={"w-full bg-blue-800 flex flex-col items-center p-5 lg:absolute bottom-0"}>
